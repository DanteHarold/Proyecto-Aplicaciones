...
public class PrincipalActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private void asignarReferencias() {
        ...
        getSupportFragmentManager().beginTransaction().add(R.id.content, new cursosfragmento()).commit();
        setTitle("Home");
    ...
    private void selectItemNav(MenuItem item) {
        ...
        switch(item.getItemId()){
            case R.id.menu_1 :
                ft.replace(R.id.content, new noticiafragmento()).commit();
                break;
            case R.id.menu_2 :
                //Intent intent3 = new Intent(PrincipalActivity.this,ListadoActivity.class);
                //startActivity(intent3);
                ft.replace(R.id.content, new cursosfragmento()).commit();
                break;
            case R.id.menu_3 :
                ft.replace(R.id.content, new notasfragmento()).commit();
                break;
            case R.id.menu_9 :
                ...
                intent.putExtra("titulo","UPN - SEDE BREÑA");
